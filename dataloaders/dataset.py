...
if __name__ == "__main__":
    ...
    train_data = VideoDataset(dataset='ucf101', split='test', clip_len=8, preprocess=False)  #execute the class for the test dataset ( i have the impression the validation dataset is never executed)
